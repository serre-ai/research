...
│   ├── b3_permutation.py  — B3: Permutation Composition (Type 3: Serial)
│   ├── b4_state_machine.py— B4: State Machine Tracking (Type 3: Serial)
│   ├── b5_graph_reach.py  — B5: Graph Reachability (Type 2: Depth)
...
4. **Tool Use** — Model writes and executes Python code via a sandboxed interpreter.
...
| B3: Permutation Composition | Type 3: Serial | L (Logspace) |
| B4: State Machine | Type 3: Serial | L (Logspace) |
| B5: Graph Reachability | Type 2: Depth | NL |
| B6: LIS | Type 4: Algorithmic | P |
| B7: 3-SAT | Type 5: Intractability | NP-complete |
| B8: Reversal Inference | Type 6: Architectural | Positional |
| B9: Negation Sensitivity | Type 6: Architectural | Compositional |

## Data Format

Raw results are not included due to size (121,614 instances). Each result
